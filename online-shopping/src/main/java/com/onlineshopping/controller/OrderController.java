...
public class OrderController {
	...
	@PostMapping("order")
	public ResponseEntity<String> customerOrder(@RequestParam("userId") int userId) throws JsonProcessingException {
		...
		return new ResponseEntity<String>("ORDER SUCCESS", HttpStatus.OK);

	}

	@GetMapping("myorder")
	public ResponseEntity<List<MyOrderResponse>> getMyOrder(@RequestParam("userId") int userId) throws JsonProcessingException {
		...
		return new ResponseEntity<List<MyOrderResponse>>(orderDatas, HttpStatus.OK);

	}

	@GetMapping("admin/allorder")
	public ResponseEntity<List<MyOrderResponse>> getAllOrder() throws JsonProcessingException {
	...
	public ResponseEntity<List<MyOrderResponse>> getOrdersByOrderId(@RequestParam("orderId") String orderId) throws JsonProcessingException {
	...
	public ResponseEntity<List<MyOrderResponse>> updateOrderDeliveryStatus(@RequestBody UpdateDeliveryStatusRequest deliveryRequest)
	...
	public ResponseEntity<List<MyOrderResponse>> assignDeliveryPersonForOrder(@RequestBody UpdateDeliveryStatusRequest deliveryRequest)
			throws JsonProcessingException {
	...
	public ResponseEntity<List<MyOrderResponse>> getMyDeliveryOrders(@RequestParam("deliveryPersonId") int deliveryPersonId)
			throws JsonProcessingException {
